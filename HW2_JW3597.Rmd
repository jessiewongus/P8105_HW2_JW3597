...
nyc_transit$distinct_stations <- paste(nyc_transit$line, nyc_transit$station_name)
View(nyc_transit$distinct_stations) 
...
View(nyc_transit$vending)
```


```{r}
library(readxl)
read_excel("./data_files/HealthyHarborWaterWheelTotals2018-7-28.xlsx")
data
